...
public class RhusHeart extends SpellBook {
    ...
    private Multimap<Attribute, AttributeModifier> buildMap() {
        ...
        builder.put(AttributeRegistry.COOLDOWN_REDUCTION.get(), new AttributeModifier(UUID.fromString("667ad88f-901d-4691-b2a2-3664e42026d3"), "Weapon modifier", .20, AttributeModifier.Operation.MULTIPLY_BASE));
